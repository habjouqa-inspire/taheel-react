...
class GmapsAddress extends Component {
  ...
  handleMarkerDragEnd = async event => {
    ...
    if ((newLng >= 34.587349601439556 && newLng <= 54.76399716827487) && (newLat >= 16.36831977105389 && newLat <= 42.13436521258608)) {
      this.setState({
        errMessage: "",
        updateMapPos: true
      })
  ...
  render() {
    const { classes, inputComponent, inputProps, boundaries, areaMode, placeAddress } = this.props
