...
import { CaptchaWrapper } from '../Styles/textCaptchaStyle'
...
class TaheelCaptcha extends Component {
  ...
  handleChange = e => {
    ...
    onChange(e.target.value,solution,solution===e.target.value)
  };
...
TaheelCaptcha.defaultProps = {
  placeholder: 'Insert captcha',
  length: 6
}

TaheelCaptcha.propTypes = {
