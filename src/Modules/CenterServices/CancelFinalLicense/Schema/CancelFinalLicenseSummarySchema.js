...
const Sections = {
    ...
    CANCELLING_REASON: {
        ...
        label: { ar: 'سبب الإلغاء', en: 'cancelling reason' },
        order: 4
    },
}
export default
    [
        ...
        },
        {
            ...
            sectionName: Sections.LICENSE_DETAILS,
            dependOn: {
                valueFunc: (values) => (values.center.type === '03' || values.center.type === '01')
            },
            options: [],
            validators: [],
        },
        ...
        },
        {
            ...
            sectionName: Sections.LICENSE_DETAILS,
            dependOn: {
                valueFunc: (values) => values.center.type === '01'
            },
            options: [],
            validators: [],
        },
        ...
        },
        {
            ...
            name: 'processVariablesDump.Commissoner.firstName',
            valueFunc: (v) => v?.processVariablesDump?.Commissoner?.firstName + ' ' + v?.processVariablesDump?.Commissoner?.lastName,
            type: 'Text',
            dependOn: {
        ...
        },
        {
            id: uuid(),
            label: {
                ar: 'سبب إلغاء الترخيص',
                en: 'Additional Number'
            },
            name: 'processVariablesDump.NewCenterLocation.cancelingReason',
            type: 'Text',
            gridSize: 4,
            sectionName: Sections.CANCELLING_REASON,
            options: [],
            validators: [],
        },
